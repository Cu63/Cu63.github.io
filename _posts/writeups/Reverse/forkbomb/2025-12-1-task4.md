...
![IMG](/assets/images/IMG_writeups/IMG_Reverse/IMG_forkbomb/IMG_task4/3.png){: height="200" .align-center}

Разбирать это лень. Вот честно. Гляну `main`

![IMG](/assets/images/IMG_writeups/IMG_Reverse/IMG_forkbomb/IMG_task4/6.jpg){: height="200" .align-center}
